...
void ordered_array_set_deleteElement(ordered_array_set *set, int value) {
    size_t posOfElementToDelete = binarySearch(set->data, set->size, value);
...
ordered_array_set ordered_array_set_union(ordered_array_set set1, ordered_array_set set2) {
    ...
    for (int i = 0; i < set2.size; i++) {
        ...
        int pos = binarySearch(sum.data, sum.size, value);
...
ordered_array_set ordered_array_set_intersection(ordered_array_set set1, ordered_array_set set2) {
    ...
    for (int i = 0; i < set2.size; i++) {
        int value = set2.data[i];
        int posSet1 = binarySearch(set1.data, set1.size, value);
...
ordered_array_set ordered_array_set_difference(ordered_array_set set1, ordered_array_set set2) {
    ...
    for (int i = 0; i < set1.size; i++) {
        ...
        int posSet2 = binarySearch(set2.data, set2.size, value);
...
ordered_array_set ordered_array_set_symmetricDifference(
    ...
    ordered_array_set r = ordered_array_set_union(a, b);
