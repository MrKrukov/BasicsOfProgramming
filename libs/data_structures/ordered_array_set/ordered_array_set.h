...
ordered_array_set ordered_array_set_intersection(ordered_array_set t1, ordered_array_set set2);

// возвращает разность множеств set1 и set2
ordered_array_set ordered_array_set_difference(ordered_array_set t1, ordered_array_set set2);
